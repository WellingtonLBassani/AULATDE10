...
re3.Redimensionar(2);
Console.WriteLine($"Retangulo 3 Area Redimensionada: {re3.CalcularArea()} e Perimetro {re3.CalcularPerimetro()}");
re2.Redimensionar(10, 15);
Console.WriteLine($"Retangulo 2 Area Redimensionada: {re2.CalcularArea()} e Perimetro {re2.CalcularPerimetro()}");